            ...
            Positioned.fill(
              ...
              child: IndexedStack(
                ...
                children: [
                  ...
                  _navigator(_articleKey,articleIndex,const ArticelScreen()),
...
class SimpleScreen extends StatelessWidget {
  const SimpleScreen({Key? key,required this.tabName, this.screenNumber = 1}) : super(key: key);
          ...
          ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => SimpleScreen(tabName: tabName,screenNumber: searchIndex+1,)));
              },
              child: Text('Click Me')),
        ],
      ),
